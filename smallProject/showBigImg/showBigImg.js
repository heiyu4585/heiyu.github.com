...
;(function(){
    var picShow = {
        ...
        addSwiperDom: function (str,index) {
            ...
            /**
             * 同级元素隐藏
             * 此处有坑:如果#EV-swiper 属于body第一级子元素,则script 标签等也属于其同级元素,也会被添加样式 display:block
             * */
                //this.options.swiperToggle ? $(this.options.swiperToggle).hide():$("#EV-swiper").siblings().hide();
            $("body").css({"overflow":"hidden"});
            $("#EV-swiper").css({"top":window.scrollY})
        },
        /**
         * 绑定关闭事件
         * */
        addBindClose:function(windowScrollY){
            $("#EV-swiper .closeBtn").on("click", function(){
                 ...
                 * 同级元素显示
                 * 此处有坑:如果#EV-swiper 属于body第一级子元素,则script 标签等也属于其同级元素,也会被添加样式 display:block
                 * 所以最好传递swiperToggle 参数
                 * */
                    //this.options.swiperToggle ? $(this.options.swiperToggle).show():$("#EV-swiper").siblings().show();
                ...
                typeof this.options.addBindClose=="function" && this.options.addBindClose();
            }.bind(this));
        },
